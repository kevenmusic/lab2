...
namespace UnitTestProject1
{
    ...
    public class ProductsTests
    {
        ...
        {
            // Arrange
            var p1 = new Product("Product A", 10.0f, 3);
            var p2 = new Product("Product A", 15.0f, 2);
            ...
            Assert.AreEqual(12.0f, result.UnitPrice);
        ...
        public void AddOperator_ProductsWithDifferentNames_ThrowsArgumentException()
        {
            // Arrange
            var p1 = new Product("Product A", 10.0f, 3);
            var p2 = new Product("Product B", 15.0f, 2);
        ...
        public void MultiplyOperator_PositiveMultiplier_ReturnsMultipliedProduct()
        {
            ...
            // Assert
            Assert.AreEqual("Product A", result.Name);
            Assert.AreEqual(10.0f, result.UnitPrice);
        ...
        {
            // Arrange
            var p1 = new Product("Product A", 10.0f, 0);
            var p2 = new Product("Product A", 15.0f, 0);
        ...
        public void AddOperator_ProductsWithNegativeQuantity_ThrowsException()
        {
            // Arrange
            var p1 = new Product("Product A", 10.0f, -3);
            var p2 = new Product("Product A", 15.0f, 2); // Второй продукт с положительным количеством
